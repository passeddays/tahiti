...
<body>
    <div class="container">
      <form class="form-signin" role="form" action='/tahiti/index.php?s=/Admin/Login/login' method='post' target='_self'>
        <h2 class="form-signin-heading">Tahiti <?php echo (L("login")); ?></h2>
